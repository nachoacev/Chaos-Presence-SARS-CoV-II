...
windows()
S_nu_ssa_CL_deaths <- lyap_k(ssa_CL_deaths,m=4,d=6,t=13,k=4,ref=200,s=40,eps=0.2)
...
write.csv(df_S_nu_ssa_SCL_CL,"C:\\Users\\ignac\\OneDrive - Universidad de Chile\\Escritorio\\Modelamietno Matematico\\Chaos-Presence-SARS-CoV-II\\data_para_R\\S_nu_ssa_SCL_CL.csv", row.names = FALSE)
```